  ...
  return (
    <div style={{ minHeight: '100vh', background: '#000', display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: 'system-ui, sans-serif' }}>
      <div style={{ textAlign: 'center', color: '#F4F5F3', maxWidth: 480, padding: '0 24px' }}>
        <div style={{ fontSize: 48, marginBottom: 24, color: '#00EF61' }}>✓</div>
        ...
        <a href="/login" style={{ display: 'inline-block', background: '#00EF61', color: '#000', fontWeight: 700, padding: '14px 32px', borderRadius: 10, textDecoration: 'none', fontSize: 15 }}>
          Fazer login
        </a>
      </div>
    </div>
